...
<form id="frmcart" name="frmcart" method="post" action="?p_id=$p_id&act=update">
  <table width="600" border="0" align="center" class="square">
    <tr>
      <td colspan="5" bgcolor="#FE5306 ">
      <b>ตะกร้าสินค้า</span></td>
    </tr>
    <tr>
      <td bgcolor="#FC9668  ">สินค้า</td>
      <td align="center" bgcolor="#FC9668  ">ราคา</td>
      <td align="center" bgcolor="#FC9668  ">จำนวน</td>
      <td align="center" bgcolor="#FC9668  ">รวม(บาท)</td>
      <td align="center" bgcolor="#FC9668  ">ลบ</td>
    </tr>
<?php
$total=0;
...
<tr>
		...
		<td>
			<button  class="btn btn-primary" type="submit"><a href="product.php">กลับหน้ารายการสินค้า</a></button>
		</td>
